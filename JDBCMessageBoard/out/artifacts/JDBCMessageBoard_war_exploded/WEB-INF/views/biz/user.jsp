        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="/editUserPrompt.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <%String birthday = "";
                            Date date = ((User)request.getAttribute("user")).getBirthday();
                            if (date != null) birthday = new SimpleDateFormat("yyyy-MM-dd").format(date);%>
                        <input name="" class="form-control" rows="3" id="birthday" value="<%=birthday%>" readonly>
                    </div>
                </div>
                <div class="form-group">
